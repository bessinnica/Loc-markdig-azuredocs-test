...
> * [ProgrammaticKey](manage-keys.md##programmatic-key), [EndpointKey](manage-keys.md#endpoint-key) (if querying many times), app ID, version ID, and [region](luis-reference-regions.md) for the LUIS app.
