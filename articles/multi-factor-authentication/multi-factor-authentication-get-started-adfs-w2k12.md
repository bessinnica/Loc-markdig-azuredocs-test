...
4. Click **Install AD FS Adapter**.
   ...
   <center><img src="./media/multi-factor-authentication-get-started-adfs-w2k12/server.png" alt="Cloud"/></center>
...
7. In the installation wizard, click <strong>Next</strong>. Azure Multi-Factor Authentication Server creates the PhoneFactor Admins group and adds the AD FS service account to the PhoneFactor Admins group.

   <center><img src="./media/multi-factor-authentication-get-started-adfs-w2k12/adapter.png" alt="Cloud"/></center>
...
11. When the adapter has been installed, you must register it with AD FS. Open Windows PowerShell and run the following command:<br>
    ...
    <center><img src="./media/multi-factor-authentication-get-started-adfs-w2k12/pshell.png" alt="Cloud"/></center>
...
<center><img src="./media/multi-factor-authentication-get-started-adfs-w2k12/global.png" alt="Cloud"/></center>
...
2. Set the value for <strong>WebServiceSdkUrl</strong> to the URL of the Multi-Factor Authentication Web Service SDK. For example:  <em>https://contoso.com/&lt;certificatename&gt;/MultiFactorAuthWebServiceSdk/PfWsSdk.asmx</em>, Where <em>certificatename</em> is the name of your certificate.  
