...
4. In the search box, type **Palo Alto Networks - Captive Portal**, select **Palo Alto Networks - Captive Portal** from result panel then click **Add** button to add the application.
    ...
    ![Palo Alto Networks - Captive Portal in the results list](./media/active-directory-saas-paloaltonetworks-captiveportal-tutorial/tutorial_paloaltocaptiveportal_addfromgallery.png)
...
8. Select **SAML Identity Provider** from the left navigation bar and click "Import" to import the metadata file.
    ...
    ![Configure Palo Alto Single Sign-on](./media/active-directory-saas-paloaltonetworks-captiveportal-tutorial/tutorial_paloaltoadmin_admin2.png)
...
2. In the applications list, select **Palo Alto Networks - Captive Portal**.
    ...
    ![The Palo Alto Networks - Captive Portal link in the Applications list](./media/active-directory-saas-paloaltonetworks-captiveportal-tutorial/tutorial_paloaltocaptiveportal_app.png)  
