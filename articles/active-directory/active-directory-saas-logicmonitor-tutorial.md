...
4. In the search box, type **LogicMonitor**.

    ![Creating an Azure AD test user](./media/active-directory-saas-logicmonitor-tutorial/tutorial_logicmonitor_search.png)

5. In the results panel, select **LogicMonitor**, and then click **Add** button to add the application.

    ![Creating an Azure AD test user](./media/active-directory-saas-logicmonitor-tutorial/tutorial_logicmonitor_addfromgallery.png)
...
9. In the **Single Sign-on (SSO) settings** section, perform the following steps:
...
4. On the **User** dialog page, perform the following steps:
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-logicmonitor-tutorial/create_aaduser_04.png) 
