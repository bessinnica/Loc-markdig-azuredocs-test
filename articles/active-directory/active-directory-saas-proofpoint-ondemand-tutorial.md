...
4. In the search box, type **Proofpoint on Demand**, select **Proofpoint on Demand** from result panel then click **Add** button to add the application.
    ...
    ![Proofpoint on Demand in the results list](./media/active-directory-saas-proofpoint-ondemand-tutorial/tutorial_proofpointondemand_addfromgallery.png)
...
2. In the applications list, select **Proofpoint on Demand**.
    ...
    ![The Proofpoint on Demand link in the Applications list](./media/active-directory-saas-proofpoint-ondemand-tutorial/tutorial_proofpointondemand_app.png)  
