...
4. In the search box, type **Cherwell**.
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-cherwell-tutorial/tutorial_cherwell_search.png)

5. In the results panel, select **Cherwell**, and then click **Add** button to add the application.

    ![Creating an Azure AD test user](./media/active-directory-saas-cherwell-tutorial/tutorial_cherwell_addfromgallery.png)
