...
4. In the search box, type **Bime**.
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-bime-tutorial/tutorial_bime_search.png)

5. In the results panel, select **Bime**, and then click **Add** button to add the application.

    ![Creating an Azure AD test user](./media/active-directory-saas-bime-tutorial/tutorial_bime_addfromgallery.png)
