...
4. In the search box, type **Bambu by Sprout Social**.
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-bambubysproutsocial-tutorial/tutorial_bambubysproutsocial_search.png)

5. In the results panel, select **Bambu by Sprout Social**, and then click **Add** button to add the application.

    ![Creating an Azure AD test user](./media/active-directory-saas-bambubysproutsocial-tutorial/tutorial_bambubysproutsocial_addfromgallery.png)
...
4. On the **User** dialog page, perform the following steps:
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-bambubysproutsocial-tutorial/create_aaduser_04.png) 
