...
4. In the search box, type **CompetencyIQ**.
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-competencyiq-tutorial/tutorial_competencyiq_search.png)

5. In the results panel, select **CompetencyIQ**, and then click **Add** button to add the application.

    ![Creating an Azure AD test user](./media/active-directory-saas-competencyiq-tutorial/tutorial_competencyiq_addfromgallery.png)
...
4. On the **User** dialog page, perform the following steps:
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-competencyiq-tutorial/create_aaduser_04.png) 
