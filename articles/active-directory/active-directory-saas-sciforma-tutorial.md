...
4. In the search box, type **Sciforma**.

    ![Creating an Azure AD test user](./media/active-directory-saas-sciforma-tutorial/tutorial_sciforma_search.png)

5. In the results panel, select **Sciforma**, and then click **Add** button to add the application.

    ![Creating an Azure AD test user](./media/active-directory-saas-sciforma-tutorial/tutorial_sciforma_addfromgallery.png)
...
3. **[Creating a Sciforma test user](#creating-a-sciforma-test-user)** - to have a counterpart of Britta Simon in Sciforma that is linked to the Azure AD representation of user.
