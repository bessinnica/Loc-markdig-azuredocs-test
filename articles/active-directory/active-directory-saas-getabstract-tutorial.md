...
4. In the search box, type **Getabstract**, select **Getabstract** from result panel then click **Add** button to add the application.
    ...
    ![Getabstract in the results list](./media/active-directory-saas-getabstract-tutorial/tutorial_getabstract_addfromgallery.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-getabstract-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Getabstract**.
    ...
    ![The Getabstract link in the Applications list](./media/active-directory-saas-getabstract-tutorial/tutorial_getabstract_app.png)  
