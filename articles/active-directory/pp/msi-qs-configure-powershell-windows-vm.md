...
1. Refer to one of the following Azure VM Quickstarts, completing only the necessary sections ("Log in to Azure", "Create resource group", "Create networking group", "Create the VM"). 
   ...
   - [Create a Windows virtual machine using PowerShell](~/articles/virtual-machines/windows/quick-create-powershell.md)
   - [Create a Linux virtual machine using PowerShell](~/articles/virtual-machines/linux/quick-create-powershell.md)
...
- For the full Azure VM creation Quickstarts, see:
  ...
  - [Create a Windows virtual machine with PowerShell](~/articles/virtual-machines/windows/quick-create-powershell.md) 
  - [Create a Linux virtual machine with PowerShell](~/articles/virtual-machines/linux/quick-create-powershell.md) 
