...
4. In the search box, type **ClickTime**, select **ClickTime** from result panel then click **Add** button to add the application.
    ...
    ![ClickTime in the results list](./media/active-directory-saas-clicktime-tutorial/tutorial_clicktime_addfromgallery.png)
...
2. In the applications list, select **ClickTime**.
    ...
    ![ClickTimne link in the Applications list](./media/active-directory-saas-clicktime-tutorial/tutorial_clicktime_app.png) 
