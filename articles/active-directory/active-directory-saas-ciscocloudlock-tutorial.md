...
4. In the search box, type **Cisco Cloudlock**, select **Cisco Cloudlock** from result panel then click **Add** button to add the application.
    ...
    ![Cisco Cloudlock in the results list](./media/active-directory-saas-ciscocloudlock-tutorial/tutorial_ciscocloudlock_addfromgallery.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-ciscocloudlock-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **Cisco Cloudlock**.
    ...
    ![The Cisco Cloudlock link in the Applications list](./media/active-directory-saas-ciscocloudlock-tutorial/tutorial_ciscocloudlock_app.png)  
