...
4. In the search box, type **SAML SSO for Bitbucket by resolution GmbH**, select **SAML SSO for Bitbucket by resolution GmbH** from result panel then click **Add** button to add the application.
    ...
    ![SAML SSO for Bitbucket by resolution GmbH in the results list](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_addfromgallery.png)
...
12. On the **Identity provider configuration page**, click **Next**.
    ...
    ![The identity config](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_identityconfig.png)
...
2. In the applications list, select **SAML SSO for Bitbucket by resolution GmbH**.
    ...
    ![The SAML SSO for Bitbucket by resolution GmbH link in the Applications list](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_app.png)  
