...
4. In the search box, type **SciQuest Spend Director**, select **SciQuest Spend Director** from result panel then click **Add** button to add the application.
    ...
    ![SciQuest Spend Director in the results list](./media/active-directory-saas-sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_addfromgallery.png)
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-sciquest-spend-director-tutorial/create_aaduser_01.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-sciquest-spend-director-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **SciQuest Spend Director**.
    ...
    ![The SciQuest Spend Director link in the Applications list](./media/active-directory-saas-sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_app.png)  
