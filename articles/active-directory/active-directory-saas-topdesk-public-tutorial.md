...
4. In the search box, type **TOPdesk - Public**, select **TOPdesk - Public** from result panel then click **Add** button to add the application.
    ...
    ![TOPdesk - Public in the results list](./media/active-directory-saas-topdesk-public-tutorial/tutorial_topdesk-public_addfromgallery.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-topdesk-public-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **TOPdesk - Public**.
    ...
    ![The TOPdesk - Public link in the Applications list](./media/active-directory-saas-topdesk-public-tutorial/tutorial_topdesk-public_app.png)  
