...
4. In the search box, type **SAML SSO for Bamboo by resolution GmbH**, select **SAML SSO for Bamboo by resolution GmbH** from result panel then click **Add** button to add the application.
    ...
    ![SAML SSO for Bamboo by resolution GmbH in the results list](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_addfromgallery.png)
...
2. On the **Single sign-on** dialog, select **Mode** as **SAML-based Sign-on** to enable single sign-on.
    ...
    ![Single sign-on dialog box](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_samlbase.png)
...
3. On the **SAML SSO for Bamboo by resolution GmbH Domain and URLs** section, perform the following steps if you wish to configure the application in IDP initiated mode:
    ...
    ![SAML SSO for Bamboo by resolution GmbH Domain and URLs single sign-on information](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_url.png)
...
4. Check **Show advanced URL settings** and perform the following step if you wish to configure the application in **SP** initiated mode:
    ...
    ![SAML SSO for Bamboo by resolution GmbH Domain and URLs single sign-on information](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_url1.png)
...
5. On the **SAML Signing Certificate** section, click **Metadata XML** and then save the metadata file on your computer.
    ...
    ![The Certificate download link](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_certificate.png) 

6. Click **Save** button.

    ![Configure Single Sign-On Save button](./media/active-directory-saas-bamboo-tutorial/tutorial_general_400.png)
...
8. On the right side of the main toolbar, click **Settings** > **Add-ons**.
    ...
    ![The Settings](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_setings.png)

9. Go to SECURITY section, click on **SAML SingleSignOn** on the Menubar.

    ![The Samlsingle](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_samlsingle.png)

10. On the **SAML SIngleSignOn Plugin Configuration page**, click **Add idp**. 

    ![The Add idp](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_addidp.png)

11. On the **Choose your SAML Identity Provider** Page, perform the following steps:

    ![The identity provider](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_identityprovider.png)
...
12. On the **Identity provider configuration** page click **Next**.
    ...
    ![The identity config](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_identityconfig.png)
...
13. On the **Import SAML Idp Metadata** Page, click **Load File** to upload the **METADATA XML** file which you have downloaded from Azure Portal.
    ...
    ![The idpmetadata](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_idpmetadata.png)

14. Click **Next**.

15. Click **Save settings**.

    ![The save](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_save.png)
...
1. In the Azure portal, in the left pane, click the **Azure Active Directory** button.
    ...
    ![The Azure Active Directory button](./media/active-directory-saas-bamboo-tutorial/create_aaduser_01.png)

2. To display the list of users, go to **Users and groups**, and then click **All users**.

    ![The "Users and groups" and "All users" links](./media/active-directory-saas-bamboo-tutorial/create_aaduser_02.png)

3. To open the **User** dialog box, click **Add** at the top of the **All Users** dialog box.

    ![The Add button](./media/active-directory-saas-bamboo-tutorial/create_aaduser_03.png)

4. In the **User** dialog box, perform the following steps:

    ![The User dialog box](./media/active-directory-saas-bamboo-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **SAML SSO for Bamboo by resolution GmbH**.
    ...
    ![The SAML SSO for Bamboo by resolution GmbH link in the Applications list](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_app.png)  
