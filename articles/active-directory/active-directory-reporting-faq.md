...
<strong>Q: I am using the <https://graph.windows.net/&lt;tenant-name&gt;/reports/> endpoint APIs to pull Azure AD audit and integrated application usage reports into our reporting systems programmatically. What should I switch to?</strong>
...
<strong>Q: I am using the <https://graph.windows.net/&lt;tenant-name&gt;/reports/> endpoint APIs to pull Azure AD security reports (specific types of detections, such as leaked credentials or sign-ins from anonymous IP addresses) into our reporting systems programmatically. What should I switch to?</strong>
