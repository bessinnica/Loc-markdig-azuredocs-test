...
4. In the search box, type **itslearning**.
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-itslearning-tutorial/tutorial_itslearning_search.png)

5. In the results panel, select **itslearning**, and then click **Add** button to add the application.

    ![Creating an Azure AD test user](./media/active-directory-saas-itslearning-tutorial/tutorial_itslearning_addfromgallery.png)
...
2. To display the list of users, go to **Users and groups** and click **All users**.
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-itslearning-tutorial/create_aaduser_02.png) 
...
2. In the applications list, select **itslearning**.
    ...
    ![Configure Single Sign-On](./media/active-directory-saas-itslearning-tutorial/tutorial_itslearning_app.png) 
