...
2. Configure single sign-on in the following order:
   ...
   a. In the <strong>Sign on URL</strong> box, ensure that the sign-on URL is set appropriately for Box in the Azure portal. This URL is the URL of your Box.com tenant. It should follow the naming convention <em>https://.box.com</em>.  
   The <strong>Identifier</strong> does not apply to this app, but it still appears as a mandatory field.
