...
| Characters not allowed | <ul> <li>Any "<xref href=" character that&#39;s not separating the username from the domain.&lt;/li&gt; &lt;li&gt;Can&#39;t contain a period character " data-throw-if-not-resolved="False" data-raw-source="@&quot; character that&#39;s not separating the username from the domain.&lt;/li&gt; &lt;li&gt;Can&#39;t contain a period character &quot;"></xref>." immediately preceding the "@" symbol</li></ul> |
|   Length constraints   |                      <ul> <li>The total length must not exceed 113 characters</li><li>There can be up to 64 characters before the "<xref href=" symbol&lt;/li&gt;&lt;li&gt;There can be up to 48 characters after the " data-throw-if-not-resolved="False" data-raw-source="@&quot; symbol&lt;/li&gt;&lt;li&gt;There can be up to 48 characters after the &quot;"></xref>@" symbol</li></ul>                      |
...
|   Password expiry duration   |                                              <ul><li>Default value: <strong>90</strong> days.</li><li>The value is configurable by using the <code>Set-MsolPasswordPolicy</code> cmdlet from the Azure Active Directory Module for Windows PowerShell.</li></ul>                                              |
| Password expiry notification |                                                                <ul><li>Default value: <strong>14</strong> days (before password expires).</li><li>The value is configurable by using the <code>Set-MsolPasswordPolicy</code> cmdlet.</li></ul>                                                                |
|       Password expiry        |                                           <ul><li>Default value: <strong>false</strong> days (indicates that password expiry is enabled).</li><li>The value can be configured for individual user accounts by using the <code>Set-MsolUser</code> cmdlet.</li></ul>                                           |
|   Password change history    |                                                                                                               The last password <em>can't</em> be used again when the user changes a password.                                                                                                                |
