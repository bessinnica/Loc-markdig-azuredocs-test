...
1. Adding SmartRecruiters from the gallery
...
For single sign-on to work, Azure AD needs to know what the counterpart user in SmartRecruiters is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in SmartRecruiters needs to be established.

In SmartRecruiters, assign the value of the **user name** in Azure AD as the value of the **Username** to establish the link relationship.
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-smartrecruiters-tutorial/create_aaduser_04.png)
...
**To assign Britta Simon to SmartRecruiters, perform the following steps:**
