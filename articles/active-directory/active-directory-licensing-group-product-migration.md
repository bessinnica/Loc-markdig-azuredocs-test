...
In order to execute the code, you will need to use the [Azure AD PowerShell v1.0 libraries](https://docs.microsoft.com/en-us/powershell/azure/active-directory/install-msonlinev1?view=azureadps-1.0] for instructions). Execute the <em>connect-msolservice</em> cmdlet first to sign in into the tenant before executing the script.
```
