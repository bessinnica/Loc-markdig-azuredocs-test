...
4. In the search box, type **Anaplan**.
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-anaplan-tutorial/tutorial_anaplan_search.png)

5. In the results panel, select **Anaplan**, and then click **Add** button to add the application.

    ![Creating an Azure AD test user](./media/active-directory-saas-anaplan-tutorial/tutorial_anaplan_addfromgallery.png)
