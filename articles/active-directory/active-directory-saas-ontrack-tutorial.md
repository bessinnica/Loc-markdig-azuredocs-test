...
4. In the search box, type **OnTrack**, select **OnTrack** from result panel then click **Add** button to add the application.
    ...
    ![OnTrack in the results list](./media/active-directory-saas-ontrack-tutorial/tutorial_ontrack_addfromgallery.png)
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-ontrack-tutorial/create_aaduser_04.png)
...
2. In the applications list, select **OnTrack**.
    ...
    ![The OnTrack link in the Applications list](./media/active-directory-saas-ontrack-tutorial/tutorial_ontrack_app.png)  
