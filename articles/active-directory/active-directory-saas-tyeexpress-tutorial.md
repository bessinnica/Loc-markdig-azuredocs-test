...
4. In the search box, type **T&E Express**.
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-tyeexpress-tutorial/tutorial_tyeexpress_search.png)

5. In the results panel, select **T&E Express**, and then click **Add** button to add the application.

    ![Creating an Azure AD test user](./media/active-directory-saas-tyeexpress-tutorial/tutorial_tyeexpress_addfromgallery.png)
...
2. Go to **Users and groups** and click **All users** to display the list of users.
    ...
    ![Creating an Azure AD test user](./media/active-directory-saas-tyeexpress-tutorial/create_aaduser_02.png) 
...
4. Enter all the mandatory details as asked in the form and click the save button to save the details.
    ...
    ![Add Employee](./media/active-directory-saas-tyeexpress-tutorial/tye-usersadd.png)
