...
1. Adding Encompass from the gallery
...
4. In the search box, type **Encompass**, select **Encompass** from result panel then click **Add** button to add the application.
    ...
    ![Encompass in the results list](./media/active-directory-saas-encompass-tutorial/tutorial_encompass_addfromgallery.png)
...
For single sign-on to work, Azure AD needs to know what the counterpart user in Encompass is to a user in Azure AD. In other words, a link relationship between an Azure AD user and the related user in Encompass needs to be established.

In Encompass, assign the value of the **user name** in Azure AD as the value of the **Username** to establish the link relationship.
...
4. In the **User** dialog box, perform the following steps:
    ...
    ![The User dialog box](./media/active-directory-saas-encompass-tutorial/create_aaduser_04.png)
...
**To assign Britta Simon to Encompass, perform the following steps:**
...
2. In the applications list, select **Encompass**.
    ...
    ![The Encompass link in the Applications list](./media/active-directory-saas-encompass-tutorial/tutorial_encompass_app.png)  
...
When you click the Encompass tile in the Access Panel, you should get automatically signed-on to your Encompass application.
