...
2. Enter these values for the listener:
   ...
   - <em>www.contoso.com</em> - replace this host name example with your domain name.

3. Click **OK**.
4. Create a second listener using the name of <em>fabrikamListener</em> and use your second domain name. In this example, <em>www.fabrikam.com</em> is used.
