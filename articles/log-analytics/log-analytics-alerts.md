...
<strong>Query:</strong> Type=Perf ObjectName=Processor CounterName="% Processor Time" | measure avg(CounterValue) by Computer Interval 5minute<br>

<strong>Time window:</strong> 30 minutes<br>

<strong>Alert frequency:</strong> 5 minutes<br>

<strong>Aggregate value:</strong> Greater than 90<br>
