...
> [!NOTE]
> Make sure that the <em>"\<username\>"</em> does not include any <em>"<xref href="servername" data-throw-if-not-resolved="False" data-raw-source="@servername"></xref>"</em> suffix. 
