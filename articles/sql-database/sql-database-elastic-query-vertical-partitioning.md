...
> [!NOTE]
> Ensure that the `<username>` does not include any <strong>"<xref href="servername" data-throw-if-not-resolved="False" data-raw-source="@servername"></xref>"</strong> suffix. 
