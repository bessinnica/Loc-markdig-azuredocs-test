...
2. Configure proxy settings on the gateway. See the [Proxy server considerations](#proxy-server-considerations) section for details.
3. Enable outbound ports 5671 and 9350-9354 on both the Windows Firewall on the gateway machine and the corporate firewall. See the [Ports and firewall](#ports-and-firewall) section for details. This step is optional, but we recommend it for performance consideration.
