...
> * [Version 1 - GA](data-factory-sap-business-warehouse-connector.md)
> * [Version 2 - Preview](../connector-sap-business-warehouse.md)

> [!NOTE]
> This article applies to version 1 of Data Factory, which is generally available (GA). If you are using version 2 of the Data Factory service, which is in preview, see [SAP Business Warehouse connector in V2](../connector-sap-business-warehouse.md).
