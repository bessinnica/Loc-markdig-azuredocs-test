...
The values for <strong><xref href="in" data-throw-if-not-resolved="False" data-raw-source="@in"></xref></strong> and <strong><xref href="out" data-throw-if-not-resolved="False" data-raw-source="@out"></xref></strong> parameters in the U-SQL script are passed dynamically by ADF using the ‘parameters’ section. See the ‘parameters’ section in the pipeline definition.
