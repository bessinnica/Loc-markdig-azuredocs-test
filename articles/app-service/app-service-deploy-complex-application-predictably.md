...
4. Next, click <strong>Deploy</strong> to start the deployment process. Once the process runs to completion, click the http://todoapp<em>XXXX</em>.azurewebsites.net link to browse the deployed application. 
