...
1. Create a file on your local computer named PrivateConf.json with these lines. Replace <strong>myUserName</strong> and <strong>myP<xref href="ssW0rd" data-throw-if-not-resolved="False" data-raw-source="@ssW0rd"></xref></strong> with your own user name and password and set your own date for expiration.
...
1. Create a file named PrivateConf.json with these contents. Replace the <strong>myUserName</strong>, <strong>mySSHKey</strong> and <strong>myP<xref href="ssW0rd" data-throw-if-not-resolved="False" data-raw-source="@ssW0rd"></xref></strong> values with your own information.
