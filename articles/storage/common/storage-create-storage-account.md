...
* Blob service: http://<em>mystorageaccount</em>.blob.core.windows.net
* Table service: http://<em>mystorageaccount</em>.table.core.windows.net
* Queue service: http://<em>mystorageaccount</em>.queue.core.windows.net
* File service: http://<em>mystorageaccount</em>.file.core.windows.net
...
The URL for accessing an object in a storage account is built by appending the object's location in the storage account to the endpoint. For example, a blob address might have this format: http://<em>mystorageaccount</em>.blob.core.windows.net/<em>mycontainer</em>/<em>myblob</em>.
