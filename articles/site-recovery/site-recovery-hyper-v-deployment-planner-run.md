...
|  -StorageAccountKey   |                                                                                                                       (Optional) The key that's used to access the storage account. Go to the Azure portal > <strong>Storage accounts</strong> > <em>storage-account name</em> > <strong>Settings</strong> > <strong>Access Keys</strong> > <strong>Key1</strong> (or the primary access key for a classic storage account).                                                                                                                       |
...
| -StorageAccountKey  |                                                                                                                                                                         The storage-account key that's used to access the storage account. Go to the Azure portal > <strong>Storage accounts</strong> > <em>storage-account name</em> > <strong>Settings</strong> > <strong>Access Keys</strong> > <strong>Key1</strong>.                                                                                                                                                                          |
