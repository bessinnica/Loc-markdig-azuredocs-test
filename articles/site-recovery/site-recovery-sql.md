...
| <strong>Physical server</strong> |                 Yes                  |            Yes            |
...
|  <strong>Version</strong>  | <strong>Edition</strong> |             <strong>Deployment</strong>             |     <strong>On-prem to on-prem</strong>     |      <strong>On-prem to Azure</strong>      |
|----------------------------|--------------------------|-----------------------------------------------------|---------------------------------------------|---------------------------------------------|
