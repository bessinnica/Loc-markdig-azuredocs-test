...
You might get this type of notification if the ratio between “good” traces (traces logged with a level of <em>Info</em> or <em>Verbose</em>) and “bad” traces (traces logged with a level of <em>Warning</em>, <em>Error, or *Fatal</em>) is degrading in a specific day, compared to a baseline calculated over the previous seven days.
